        ...
        {tab === 'agenda' && (
          <>
            ...
            {loadingBookings ? (
              ...
              <div className="space-y-3">
                {bookings.map((b) => (
                  <Card key={b.id} variant="glass" padding="none" className="overflow-hidden">
                    <div className="p-4 flex flex-wrap items-center gap-3">
                      <div className="text-center flex-shrink-0 w-16">
                        <p className="text-lg font-bold text-gray-900">{timeAR(b.starts_at)}</p>
                        <p className="text-[11px] text-gray-400">{timeAR(b.ends_at)}</p>
                      </div>
                      ...
                      <a
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-[#25D366]/10 text-[#128C42] rounded-lg text-sm font-semibold hover:bg-[#25D366]/20 transition-colors flex-shrink-0"
                      ...
                      >
                        ...
                        <span className="hidden sm:inline">{b.customer_phone}</span>
                      </a>
