  ...
  return (
    <div className="min-h-screen bg-[#fafaf8] text-gray-900 antialiased">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-20 md:pb-24">
        <div className="rounded-3xl border border-indigo-200/70 bg-gradient-to-br from-indigo-50 via-white to-amber-50/40 p-8 md:p-12 overflow-hidden">
          <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
                Turnos online, sin ida y vuelta de mensajes
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Tus clientes eligen día y horario desde tu página y reservan con
                su nombre y teléfono. Vos manejás todo desde tu panel.
              </p>
              <ul className="space-y-3 mb-8">
                {[
                  'Definí qué se reserva y cuántos entran a la vez: 2 sillas de barbería, 2 canchas, mesas de 2, 4 y 6',
                  'Agenda por día con confirmación automática o aprobación manual',
                  'El cliente confirma por WhatsApp y puede cancelar con su link (si lo permitís)',
                  'Horarios propios por recurso, feriados y anticipación mínima/máxima',
                ].map((item) => (
            ...
            {/* Mockup del flujo de reserva */}
            <div className="flex justify-center">
              <div className="w-full max-w-xs bg-white rounded-3xl shadow-xl border border-gray-200/70 p-5">
                <p className="text-sm font-bold text-gray-900 mb-1">Reservar turno</p>
                <p className="text-xs text-gray-500 mb-4">Cancha de 5 · 60 min</p>
                <div className="flex gap-1.5 mb-4">
                  {[
                    { dow: 'jue', day: '10' },
                    { dow: 'vie', day: '11', active: true },
                    { dow: 'sáb', day: '12' },
                    { dow: 'dom', day: '13' },
                  ].map((d) => (
                    <div
                      key={d.day}
                      className={`flex-1 flex flex-col items-center py-2 rounded-xl border-2 text-center ${
                        d.active
                          ? 'border-indigo-600 bg-indigo-600 text-white'
                          : 'border-gray-200 text-gray-600'
                      }`}
                    >
                      <span className="text-[9px] uppercase font-semibold opacity-70">{d.dow}</span>
                ...
                <div className="grid grid-cols-3 gap-1.5 mb-4">
                  {[
                    ...
                    <div
                      key={s.t}
                      className={`py-2 rounded-lg text-xs font-semibold text-center border-2 ${
                        s.sel
                          ? 'border-indigo-600 bg-indigo-600 text-white'
                          : s.full
                ...
                <div className="flex items-center gap-2 px-3 py-2.5 bg-green-50 border border-green-200 rounded-xl">
                  ...
                  <p className="text-xs text-green-800 font-semibold">
                    Reserva confirmada · vie 20:00 hs
                  </p>
                </div>
              </div>
            </div>
